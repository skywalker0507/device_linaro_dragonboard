...
# Install scripts to update lt9611uxc firmware version to v43.
# Start this service from shell with selinux in permissive mode.
# adb root; adb shell setenforce 0; adb shell start lt9611uxc_fw_update
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/lt9611uxc_fw_update.rc:/system/etc/init/lt9611uxc_fw_update.rc \
    $(LOCAL_PATH)/lt9611uxc_fw_update.sh:/system/bin/lt9611uxc_fw_update.sh
