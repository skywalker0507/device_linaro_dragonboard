...
ifeq ($(TARGET_SDCARD_BOOT), true)
  BOARD_VENDOR_KERNEL_MODULES := $(TARGET_KERNEL_DIR)/ufs-qcom.ko
...
ifeq ($(TARGET_SDCARD_BOOT), true)
  PRODUCT_COPY_FILES += \
      device/linaro/dragonboard/shared/utils/sdcard-boot/fstab:$(TARGET_COPY_OUT_RAMDISK)/first_stage_ramdisk/fstab.$(TARGET_HARDWARE) \
      device/linaro/dragonboard/shared/utils/sdcard-boot/fstab:$(TARGET_COPY_OUT_VENDOR)/etc/fstab.$(TARGET_HARDWARE)
else
  PRODUCT_COPY_FILES += \
