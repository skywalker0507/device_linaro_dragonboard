...
# Board Information
TARGET_BOOTLOADER_BOARD_NAME := linaro_blueline
TARGET_BOARD_PLATFORM := linaro_blueline
...
BOARD_KERNEL_CMDLINE := firmware_class.path=/vendor/firmware/ androidboot.hardware=linaro_blueline efi=noruntime
