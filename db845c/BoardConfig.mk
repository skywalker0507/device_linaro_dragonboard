...
ifeq ($(TARGET_USES_BOOT_HDR_V2), true)
  BOARD_BOOT_HEADER_VERSION := 2
  BOARD_KERNEL_CMDLINE += androidboot.hardware=db845c androidboot.boot_devices=soc@0/8804000.mmc
...
ifeq ($(TARGET_USES_BOOT_HDR_V2), false)
